      ...
      switch (spec.comparator_kind) {
        case ConformanceComparatorKind::kMse:
          if (actual[i].Type().ElementType() == ElementType::Float32) {
            CheckMseOutputImpl(actual[i].AsView<float>(),
                               ref[i].AsView<float>(), spec.absolute_tolerance);
          } else if (actual[i].Type().ElementType() == ElementType::Int8) {
            CheckMseOutputImpl(actual[i].AsView<int8_t>(),
                               ref[i].AsView<int8_t>(),
        ...
        case ConformanceComparatorKind::kExact:
          if (actual[i].Type().ElementType() == ElementType::Float32) {
            CheckExactOutputImpl(actual[i].AsView<float>(),
                                 ref[i].AsView<float>());
          } else if (actual[i].Type().ElementType() == ElementType::Int8) {
            CheckExactOutputImpl(actual[i].AsView<int8_t>(),
                                 ref[i].AsView<int8_t>());
          } else if (actual[i].Type().ElementType() == ElementType::UInt8) {
