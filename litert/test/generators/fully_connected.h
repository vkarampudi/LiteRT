...
inline constexpr double kSymmetricHybridReferenceTolerance = 1.5e-2;
...
constexpr PresetDescriptor MakeDescriptor(
    ...
    bool hybrid = false, bool bias_always_present = false,
    bool bias_never_present = false, bool fixed_activation = false,
    tflite::ActivationFunctionType activation =
        tflite::ActivationFunctionType_NONE,
...
constexpr PresetDescriptor MakeDescriptor(
    ...
    bool per_channel, bool hybrid, bool bias_always_present,
    bool bias_never_present, double reference_tolerance, int fixed_rank = 0,
    int keep_num_dims_mode = -1, bool flatten_all_non_batch_dims = false,
    bool asymmetric_quantize_inputs = false) {
  return MakeDescriptor(name, input_type, filter_type, output_type, bias_type,
                        weights_format, dynamic_filter, dynamic_bias,
                        fp16_filter, fp16_bias, per_channel, hybrid,
  ...
  switch (preset) {
    case FullyConnectedPreset::kFloatStatic:
      return MakeDescriptor(
          ...
          /*per_channel=*/false, /*hybrid=*/false,
...
inline LiteRtElementType QuantizedBiasType(const PresetDescriptor& descriptor) {
  return descriptor.hybrid ? kLiteRtElementTypeFloat32 : descriptor.bias_type;
}
...
using FullyConnectedAtsCpuPresets = FullyConnectedPresetListC<
    FullyConnectedPreset::kFloatStatic, FullyConnectedPreset::kUint8Static,
    FullyConnectedPreset::kInt8Static,
    FullyConnectedPreset::kInt8PerChannelStatic,
    FullyConnectedPreset::kInt16Int8StaticInt32Bias,
    FullyConnectedPreset::kInt16Int16StaticInt32Bias,
    FullyConnectedPreset::kInt16Int16PerChannelStaticInt32Bias>;
